...
namespace _6.Working_numbers
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //BODMAS still applies, 4+2*3 gets 10, use use brackets to change the order
            ...
            //calling mathods eg the math method, Abs means Absolute
            //u will get always get the positive number
